...
@JvmOverloads constructor(
    ...
    class Type(override val name: String) : AttributeCollection.Type<JobMediaSheetsCol>(Members)
    ...
    /** Builder for immutable [JobMediaSheetsCol] objects. */
    class Builder() {
        /** Constructs a new [Builder] pre-initialized with values in [source]. */
        constructor(source: JobMediaSheetsCol) : this() {
            blank = source.blank
        ...
        /** Return a new [JobMediaSheetsCol] object containing all values initialized in this builder. */
        fun build() = JobMediaSheetsCol(
            blank,
            blankTwoSided,
            fullColor,
            fullColorTwoSided,
    ...
    companion object Members : AttributeCollection.Converter<JobMediaSheetsCol> {
