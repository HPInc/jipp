...
import com.hp.jipp.pwg.DocumentStatusGroup
...
import com.hp.jipp.pwg.PrinterStatusGroup

/** Attribute types from various specifications */
object Types {
    @JvmField val attributesCharset = OperationGroup.attributesCharset
    @JvmField val attributesNaturalLanguage = DocumentStatusGroup.attributesNaturalLanguage
    @JvmField val charsetConfigured = PrinterDescriptionGroup.charsetConfigured
    @JvmField val charsetSupported = PrinterDescriptionGroup.charsetSupported
    ...
    @JvmField val identifyActions = OperationGroup.identifyActions
    @JvmField val identifyActionsDefault = PrinterDescriptionGroup.identifyActionsDefault
    @JvmField val identifyActionsSupported = PrinterDescriptionGroup.identifyActionsSupported
    ...
    @JvmField val jobPasswordEncryption = OperationGroup.jobPasswordEncryption
    @JvmField val jobPasswordEncryptionSupported = PrinterDescriptionGroup.jobPasswordEncryptionSupported
...
//    @JvmField val mediaSizeSupported = CollectionType("media-size-supported")
    ...
    @JvmField val printerAlert = PrinterStatusGroup.printerAlert
    ...
    @JvmField val printerInputTray = PrinterStatusGroup.printerInputTray
    @JvmField val printerMakeAndModel = TextType( "printer-make-and-model")
    @JvmField val printerName = NameType("printer-name")
    @JvmField val printerOutputTray = PrinterStatusGroup.printerOutputTray
    ...
    @JvmField val printerSupply = PrinterStatusGroup.printerSupply
    ...
    @JvmField val requestedAttributes = OperationGroup.requestedAttributes
