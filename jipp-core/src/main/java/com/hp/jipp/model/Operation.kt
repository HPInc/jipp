...
data class Operation(override val code: Int, override val name: String) : Enum() {
    ...
    object Code {
        ...
        const val acknowledgeEncryptedJobAttributes = 0x0068
        const val fetchEncryptedJobAttributes = 0x0069
        const val getEncryptedJobAttributes = 0x006A
    }
    ...
    companion object {
        ...
        @JvmField val acknowledgeEncryptedJobAttributes = Operation(Code.acknowledgeEncryptedJobAttributes, "Acknowledge-Encrypted-Job-Attributes")
        @JvmField val fetchEncryptedJobAttributes = Operation(Code.fetchEncryptedJobAttributes, "Fetch-Encrypted-Job-Attributes")
        @JvmField val getEncryptedJobAttributes = Operation(Code.getEncryptedJobAttributes, "Get-Encrypted-Job-Attributes")
        ...
        @JvmField val all = listOf(
            ...
            restartOnePrinter,
            acknowledgeEncryptedJobAttributes,
            fetchEncryptedJobAttributes,
            getEncryptedJobAttributes,
