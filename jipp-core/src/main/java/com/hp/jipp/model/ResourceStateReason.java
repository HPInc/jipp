...
/**
 * Values applicable for "resource-state-reasons" keywords.
 *
 * @see <a href="https://ftp.pwg.org/pub/pwg/candidates/cs-ippsystem11-20250328-5100.22.pdf">PWG5100.22</a>
 * @see <a href="https://ftp.pwg.org/pub/pwg/candidates/cs-ippsystem10-20191122-5100.22.pdf">PWG5100.22-2019</a>
 */
public class ResourceStateReason {
    ...
    public static final String cancelRequested = "cancel-requested";
    ...
    public static final String installRequested = "install-requested";
    public static final String jobCanceledAfterTimeout = "job-canceled-after-timeout";
    ...
    public static final String jobHeldForAuthorization = "job-held-for-authorization";
    public static final String jobHeldForButtonPress = "job-held-for-button-press";
    public static final String jobHeldForRelease = "job-held-for-release";
    ...
    public static final String jobStored = "job-stored";
    public static final String jobStoring = "job-storing";
    ...
    public static final String jobSuspendedForApproval = "job-suspended-for-approval";
    ...
    public static final String resourceIncoming = "resource-incoming";
