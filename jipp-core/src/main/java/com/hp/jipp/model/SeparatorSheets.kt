...
constructor(
    ...
    /** May contain any keyword from [SeparatorSheetsType] or a name. */
    var separatorSheetsType: List<KeywordOrName>? = null,
) : AttributeCollection {
    ...
    companion object : AttributeCollection.Converter<SeparatorSheets> {
        ...
        @JvmField val separatorSheetsType = KeywordOrNameType.Set("separator-sheets-type")
    }
