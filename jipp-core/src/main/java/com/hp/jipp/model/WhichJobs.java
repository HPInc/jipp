...
public class WhichJobs {
    ...
    public static final String storedGroup = "stored-group";
    public static final String storedOwner = "stored-owner";
    public static final String storedPublic = "stored-public";
}