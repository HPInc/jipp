 ...
 * @see <a href="https://ftp.pwg.org/pub/pwg/ipp/registrations/hp-marker-reasons-20230601.txt">HP20230601</a>
 * @see <a href="https://ftp.pwg.org/pub/pwg/ipp/registrations/hp-cooling-down-20181213.txt">HPINC20180215</a>
 * @see <a href="https://ftp.pwg.org/pub/pwg/ipp/registrations/reg-ippwifi10-20240912.pdf">IPPWIFI</a>
 ...
 * @see <a href="https://ftp.pwg.org/pub/pwg/ipp/wd/wd-ipptrustnoone10-20210519.pdf">PWG5100.TRUSTNOONE</a>
...
public class PrinterStateReason {
    ...
    public static final String encryptedJobAttributesRequested = "encrypted-job-attributes-requested";
    ...
    public static final String markerAdded = "marker-added";
    public static final String markerAdjustingPrintQuality = "marker-adjusting-print-quality";
    public static final String markerAtLimit = "marker-at-limit";
    public static final String markerCarrierFailure = "marker-carrier-failure";
    public static final String markerCleanerMissing = "marker-cleaner-missing";
    public static final String markerClosed = "marker-closed";
    ...
    public static final String markerLifeAlmostOver = "marker-life-almost-over";
    public static final String markerLifeOver = "marker-life-over";
    public static final String markerMemoryExhausted = "marker-memory-exhausted";
    public static final String markerMissing = "marker-missing";
    public static final String markerMotorFailure = "marker-motor-failure";
    public static final String markerNearLimit = "marker-near-limit";
    public static final String markerOffline = "marker-offline";
    public static final String markerOpcMissing = "marker-opc-missing";
    public static final String markerOpened = "marker-opened";
    public static final String markerOverTemperature = "marker-over-temperature";
    public static final String markerPowerSaver = "marker-power-saver";
    ...
    public static final String markerRecoverableFailure = "marker-recoverable-failure";
    public static final String markerRemoved = "marker-removed";
    public static final String markerResourceAdded = "marker-resource-added";
    public static final String markerResourceRemoved = "marker-resource-removed";
    ...
    public static final String markerSupplyFailure = "marker-supply-failure";
    ...
    public static final String markerThermistorFailure = "marker-thermistor-failure";
    public static final String markerTimingFailure = "marker-timing-failure";
    ...
    public static final String markerTurnedOff = "marker-turned-off";
    public static final String markerTurnedOn = "marker-turned-on";
    public static final String markerUnderTemperature = "marker-under-temperature";
    public static final String markerUnrecoverableFailure = "marker-unrecoverable-failure";
    public static final String markerWarmingUp = "marker-warming-up";
    ...
    public static final String storageAdded = "storage-added";
    public static final String storageAlmostFull = "storage-almost-full";
    public static final String storageConfigurationChange = "storage-configuration-change";
    public static final String storageCoverClosed = "storage-cover-closed";
    public static final String storageCoverOpen = "storage-cover-open";
    public static final String storageFull = "storage-full";
    public static final String storageInterlockClosed = "storage-interlock-closed";
    public static final String storageInterlockOpen = "storage-interlock-open";
    public static final String storageLifeAlmostOver = "storage-life-almost-over";
    public static final String storageLifeOver = "storage-life-over";
    public static final String storageMissing = "storage-missing";
    public static final String storageOffline = "storage-offline";
    public static final String storageOverTemperature = "storage-over-temperature";
    public static final String storagePowerSaver = "storage-power-saver";
    public static final String storageRecoverableFailure = "storage-recoverable-failure";
    public static final String storageRemoved = "storage-removed";
    public static final String storageThermistorFailure = "storage-thermistor-failure";
    public static final String storageTurnedOff = "storage-turned-off";
    public static final String storageTurnedOn = "storage-turned-on";
    public static final String storageUnderTemperature = "storage-under-temperature";
    public static final String storageUnrecoverableFailure = "storage-unrecoverable-failure";
    public static final String storageWarmingUp = "storage-warming-up";
    ...
    public static final String wifiNotConfigured = "wifi-not-configured";
