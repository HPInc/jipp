...
class ColorSpaceTest {
    ...
    fun `RGBA to Grayscale`() {
        assertEquals("ff0036b612", ("ffffffff" + "000000ff" + "ff0000ff" + "00ff00ff" + "0000ffff")
            .convert(ColorSpace.Rgba, ColorSpace.Grayscale))

        // At half alpha, half white
        assertEquals("ff7f9adb88", ("ffffff80" + "00000080" + "ff000080" + "00ff0080" + "0000ff80")
            .convert(ColorSpace.Rgba, ColorSpace.Grayscale))

        // At no alpha, pure white
        assertEquals("ffffffffff", ("ffffff00" + "00000000" + "ff000000" + "00ff0000" + "0000ff00")
            .convert(ColorSpace.Rgba, ColorSpace.Grayscale))
    }

    @Test
    fun `RGBA to RGB`() {
        assertEquals("ffffff" + "000000" + "ff0000" + "00ff00" + "0000ff",
            ("ffffffff" + "000000ff" + "ff0000ff" + "00ff00ff" + "0000ffff")
                .convert(ColorSpace.Rgba, ColorSpace.Rgb))

        assertEquals("ffffff" + "7f7f7f" + "ff7f7f" + "7fff7f" + "7f7fff",
            ("ffffff80" + "00000080" + "ff000080" + "00ff0080" + "0000ff80")
                .convert(ColorSpace.Rgba, ColorSpace.Rgb))

        assertEquals("ffffff" + "ffffff" + "ffffff" + "ffffff" + "ffffff",
    ...
    @Test
    fun `RGBA to RGBA`() {
        assertEquals(("ffffffff" + "000000ff" + "ff0000ff" + "00ff00ff" + "0000ffff"),
            ("ffffffff" + "000000ff" + "ff0000ff" + "00ff00ff" + "0000ffff")
    ...
    fun `RGB to Grayscale`() {
        assertEquals("ff0036b612", ("ffffff" + "000000" + "ff0000" + "00ff00" + "0000ff")
    ...
    fun `RGB to RGBA`() {
        ...
        assertEquals("123456ff" + "789abcff",
    ...
    fun `Grayscale to RGB`() {
        assertEquals("ffffff" + "7f7f7f" + "9a9a9a" + "dbdbdb" + "000000",
            "ff7f9adb00".convert(ColorSpace.Grayscale, ColorSpace.Rgb))
    }

    @Test
    fun `Grayscale to RGBA`() {
        assertEquals("ffffffff" + "7f7f7fff" + "9a9a9aff" + "dbdbdbff" + "000000ff",
